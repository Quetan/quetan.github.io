...
const WeOfferBlock: FC<IProps> = ({ offer }) => {
	return (
		<article className="scale-100 drop-shadow-none text-left h-full shadow-inner shadow-primary/10 rounded flex flex-col gap-2 py-8 px-6 border-2 tracking-tight bg-gradient-to-br from-muted/75 to-background/75 backdrop-blur leading-tight hover:shadow-2xl hover:shadow-accent/20 cursor-pointer transition-shadow">
